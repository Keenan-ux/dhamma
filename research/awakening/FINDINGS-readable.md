# Awakening in the Pāli Texts: who is said to awaken, when the passages were written, and in whose voice the claim is made

## Abstract

When the Pāli texts report an awakening, the report is rarely a private moment of solitary striving. More often a story carries it: a listener's mind comes free at the close of a talk, an elder sings the moment his striving ended, a compiler notes that a hearer's eye of the Dhamma has opened. Gathering every such moment in the corpus and asking three plain questions of it, who awakens, when the passage was written, and in whose voice the claim is made, yields a picture the usual division between canon and commentary does not quite predict. The events the tradition files as canonical turn out to be mostly late by composition rather than part of the old core, with one late stratum of autobiographical verse supplying more than half of them. They are mostly narrated about the awakened rather than spoken by the Buddha of himself. Yet a thin, genuine seam of the Buddha's own first-person account of his awakening does survive at the base of the canonical material. This survey describes that shape and marks the limits of saying so.
...
An awakening in these texts announces itself, when it announces itself at all, through a small set of stock phrases. The literature is formulaic by design, and that formulaic quality is what makes a count possible: the moment of release tends to be marked, not described afresh each time. Those markers are stable across centuries of redaction, so a count of them tracks a real habit of the texts rather than a category pressed onto them from outside. The object of this study, then, is not awakening as an inner state, which leaves no textual trace one can count, but the awakening-*event*, a passage in which one of these recognised phrases reports that someone has reached the goal or a stage of it. A few families of marker carry most of the weight:

- **The mind freed from clinging.** A narrator reports that, through not clinging, a person's mind was released from the corrupting influences. This is the plainest report of full awakening.[^4]
- **The eye of the Dhamma arises.** At the close of a teaching a listener's "dust-free, stainless eye of the Dhamma" opens, the stock formula for the first breakthrough, stream-entry.[^5]
- **Birth is destroyed.** The released person, or a narrator on their behalf, declares that "birth is destroyed," that the round of rebirth is finished, a marker that closes many first-person attainment verses.[^6]
- **The mass awakening at a talk's close.** A formula notes that at the conclusion of a graduated talk a hearer, or many hearers at once, broke through.[^7]

These are the surface that any count must find. Whether one finds two such events or two thousand depends almost entirely on how widely the surface is searched, which is the point of the short note that follows.

### How these were found

The search ran over the live canonical and commentarial corpus of 194,710 passages, with the Chattha Saṅgāyana recension as ingested as the base edition and the SuttaCentral Mahāsaṅgīti reading text as the parallel canonical reading. Three independent readers coded the load-bearing category, the passages in which the Buddha speaks of his own awakening, and agreed without exception (κ = 1.0).

Every count reported here is a floor, not a ceiling. The markers were searched from the plainest surface string, the kind a non-specialist would type, outward to glyph- and inflection-tolerant forms and then to concept-level phrasing that does not depend on any single word. The first, narrowest attempt finds almost nothing, and not because the events are absent: the base edition writes one Pāli nasal with a dotted character where the more familiar spelling uses a barred one, so the commonest naive search slides off nearly the whole corpus. What each successive widening of the search recovers is shown in Fig. 1 and set out rung by rung in Appendix B. Widening the search did not move the final event count, which settles at 2,214 once non-events are removed; it only confirmed how much the narrow searches miss.[^8] The figures in this paper are best read as the conservative end of what the corpus holds, never as a closed tally.

> **Fig. 1. Every count is a floor: the plainest search finds almost nothing; the census sits at the bottom of a measured ladder.**
> *Awakening-events recovered as the search is widened from a naive surface string to concept-level phrasing. Counts only, over the Chattha Saṅgāyana corpus; rung-by-rung detail in Appendix B.*
>
> ```
> naive surface string        ▏ 2
> form-tolerant search        ████████████▏ 914
> concept-level phrasing      ████████████████████▏ 1,488
...
> EARLY  ───────────────────────────────────────────────────────────────►  LATE
>
>  Nikāya prose      ●●●            33   (early floor)
>  Udāna             ●               5   (early floor)
>  Thera/Therī       ◐◐◐◐           59   (contested)
>  Apadāna           ○○○○○○○○○○○   162   (late, narrated)
>  Buddhavaṁsa       ○               8   (late, narrated)
>  Niddesa           ○               3   (late, narrated)
>  Vinaya nidāna     ○               6   (late, narrated)
>  Vimānavatthu      ○               2   (late, narrated)
>  Milindapañha      ○               4   (paracanonical)
>  Visuddhimagga     ○○             17   (commentary)
> ```
>
> *Full per-work counts and per-row detail in Appendix A.*[^21]
...
Several limits bound how far that reading can be pressed, and they are best stated plainly rather than smoothed over.

- The dating here is relative order, not calendar date. It rests on standard philological grounds for placing the Apadāna, Buddhavaṁsa, and Niddesa late and the Visuddhimagga later still, and it imports no absolute years. Two of the cells are held at lower confidence because a matter of register or position is standing in for a date: the Theragāthā and Therīgāthā material, late by the cast of its biographical frame rather than the age of its verse, and the Vinaya notices, late by their position in an occasioning-story. The lopsided shape survives the removal of both, since the Apadāna alone keeps the late bulk larger than the entire early floor.[^24]
- The census reaches only awakenings told with one of the stock phrases. An awakening narrated without any of them is not caught here, so every count is best read as a measured floor rather than a proven-complete total.[^25]
- The count of the Buddha's own-awakening passages is bounded by the reach of the earlier reading it draws on, not by the whole canon. Nine recollections is a floor: the same first-person frame, searched in its own right, turns up in some 48 places across the canon, most of them outside the 299.[^26]
- The check against other textual traditions is a matter of whether a parallel exists, not of reading those parallels feature by feature; it is offered as corroboration of the early floor, not as a finding in its own right.[^27]
- The surface-string counts depend on the spelling conventions of the particular edition used; the line between what is told by a reporter and what is spoken by the Buddha does not.[^28]

What the data cannot do is say why the shape is as it is. It seems to me that to ask how the canon describes awakening is already to ask about a body of text that is mostly late and mostly narrated, with the Buddha's own account of his bodhi as its small early heart. Whether that heart is the historical seed the later verse grew up around, or simply the part the tradition chose to keep in his own voice, the present count cannot decide. It can only show, in the texts as we have them, how much was sung about the awakened and how little was staked by the one who awoke. As one of the early notices has it, when the teaching had run its course the listener's "dust-free, stainless eye of the Dhamma arose."[^29]

---

## Notes

[^1]: The three images are, in order, the mass-awakening close of a graduated talk, *desanāpariyosāne* ("at the conclusion of the talk"); the elder's first-person attainment verse; and the stock stream-entry formula *virajaṁ vītamalaṁ dhammacakkhuṁ udapādi* ("the dust-free, stainless eye of the Dhamma arose"). Representative loci: DN 5 (Kūṭadanta); Therāpadāna 25; UD 1.10 (Bāhiya).
...
[^5]: *virajaṁ vītamalaṁ dhammacakkhuṁ udapādi* ("the dust-free, stainless eye of the Dhamma arose"); the stock marker of stream-entry. Representative locus DN 5; CST sibling cst-s0101m.mul-dn1_5.

[^6]: *khīṇā jāti* ("birth is destroyed"); the destroyed-rebirth marker that closes many attainment verses, including in the Apadāna.

[^7]: *desanāpariyosāne* ("at the conclusion of the graduated talk"), the marker of awakening, single or mass, at a teaching's close.

[^8]: The widening of the search proceeds in four rungs, with yields of 2, 914, 1,488, and 2,214 events; the final figure is the event count after non-events are removed. The earliest, narrowest rung is suppressed by an edition convention rather than by absence: the Chattha Saṅgāyana recension writes the niggahita with a dotted *ṃ*, so a naive surface string in the more familiar *ṁ* form recovers almost nothing. Full rung-by-rung yields and the normalisation step in Appendix B. The widening did not alter the fixed canonical total of 299 or the corpus total of 2,214; it is a measure of the surface string, reported so the counts can be read as floors.

[^9]: The 38 comprise Nikāya prose, 33, and the Udāna, 5. Representative early-floor loci: DN 5 (Kūṭadanta); MN 74 (Dīghanakha); UD 1.10 (Bāhiya). Of the 2,214 awakening-events in the whole corpus, 299 carry the canonical tag and 1,915 are commentarial or extra-canonical; a direct group-by over the layer column returns mula 299, Aṭṭhakathā 1,762, Ṭīkā 118, and other 35, summing to the corpus total.
...
[^13]: Buddhavaṁsa 10 (Padumabuddhavaṁsa), CST sibling cst-s0511m; the Vimānavatthu verse awakenings (work slug vv); Milindapañha 3.7.3 (cst-s0518m), Nāgasena's paracanonical dialogue. The two sub-counts are 10 lineage and frame verse (Buddhavaṁsa 8 plus Vimānavatthu 2) plus 4 dialogue. Signatures [stratum: late-canonical | layer: mula | speaker: redactor-frame-verse | register: lineage verse | edition: CST] and [stratum: paracanonical | layer: mula | speaker: named-disciple-dialogue | register: dialogue | edition: CST].

[^14]: The three first-person forms are the seeker-before-the-night frame, *pubbeva me, bhikkhave, sambodhā anabhisambuddhassa bodhisattasseva sato* ("before my awakening, monks, while I was still an unawakened seeker"); the claim of awakening, *anuttaraṁ sammāsambodhiṁ abhisambuddhoti paccaññāsiṁ* ("I claimed to be awakened to unsurpassed perfect awakening," SN 35.13, CST sibling cst-s0304m.mul-sn4_1); and the last-watch autobiography to a named hearer, *ayaṁ kho me, brāhmaṇa, rattiyā pacchime yāme tatiyā vijjā adhigatā* ("this, brahmin, was the third true knowledge attained by me in the last watch of the night," MN 4). SN 54.8 carries the same in the breath-meditation register, *anupādāya ca me āsavehi cittaṁ vimucci* ("and through not clinging my mind was freed from the taints").

[^15]: The seventeen rows: mn4, mn19, mn36, mn85, mn100, an8.11, sn54.8, and the CST sibling rows cst-s0201m.mul-mn1_1, cst-s0201m.mul-mn1_2, cst-s0202m.mul-mn2_4, cst-s0202m.mul-mn2_5, cst-s0304m.mul-sn4_1 (SN 35.13), cst-s0305m.mul-sn5_10 (SN 54.8), cst-s0404m1.mul-an8_1_2, cst-vin01m.mul-vin1_1, cst-vin02m2.mul-vin3_1, pli-tv-bu-vb-pj1. Human loci of the nine distinct recollections: MN 4, MN 19, MN 36 (to Aggivessana), MN 85 (to Prince Bodhi), MN 100 (to the brahmin Saṅgārava), AN 8.11 (to the brahmin of Verañja, repeated verbatim as the Pārājika occasioning-story), SN 54.8, SN 35.13, and the Vinaya Mahāvagga bodhi-narrative. Per-claim signature [stratum: early-canonical | layer: mula | speaker: buddha-vacana | register: prose | edition: CST]. Full dedup grouping in Appendix A.

[^16]: Three readers coded each of the seventeen candidate rows independently and blind, from the Pāli alone, against a fixed codebook; agreement on the load-bearing category was complete (κ = 1.0). The full matrix and adjudication notes are in Appendix C.

[^17]: MN 4 (Bhayabherava), the Buddha to the brahmin Jāṇussoṇi. The watch-by-watch refrain is the *ayaṁ kho me, brāhmaṇa … tatiyā vijjā adhigatā* form glossed in note 14.

[^18]: The relational search over the canonical rows finds the destiny-declaration formula across 29 rows and the declared-final-knowledge phrase *aññaṁ byākāsi* ("declared final knowledge") across 10; the "mirror of the Dhamma" post-mortem declarations at Nādika span DN, MN, SN, and AN. These are reported as a corroborating search, not as part of the 299-row attribution count.
...
[^23]: UD 1.10 (Bāhiya of the Bark-cloth), ud1.10; coded redactor-frame, early-canonical. The source carries no isolable Pāli string for the liberation line; it is given here in English only.

[^24]: The contested cells are the Theragāthā/Therīgāthā register and the Vinaya occasioning-story position. Read as early rather than late, the early floor would grow at most by the Theragāthā/Therīgāthā share (59); even then the Apadāna alone (162) keeps the late bulk larger than the early floor. Stratigraphy rests on consensus philological grounds (Apadāna, Buddhavaṁsa, Niddesa membership; Visuddhimagga authorship) and imports no absolute dates.

[^25]: The markers searched run from the stock attainment phrases (the mind freed without clinging, the dust-free eye of the Dhamma, birth destroyed, the mass-awakening at a talk's close) out to concept-level paraphrase; what each rung of that search recovers is in Appendix B, and the span is shown in Figure 1 (§II). An awakening told with none of the phrases is not captured.

[^26]: See note 20. The figure of 48 is itself a search-bounded observation, not a re-enumeration; the 299 are held fixed so that the attribution correction is not confounded with a re-census.

[^27]: Several of the early-canonical Nikāya-prose rows carry external (Chinese and Sanskrit) parallels in the corpus parallel table, a link-level proxy for a pre-sectarian core of the bare awakening notice. A work-level parallel does not make the autobiographical-verse feature early; the distinction between a shared container and a shared feature is kept. Reported as corroboration only.

[^28]: The surface-string counts are relative to the Chattha Saṅgāyana segmentation and its dotted-*ṃ* niggahita spelling; under a different edition the raw string yields would shift. The line between redactor-frame and the Buddha's own word does not depend on the edition.

[^29]: The stock stream-entry formula, *virajaṁ vītamalaṁ dhammacakkhuṁ udapādi*, given here in the gloss used throughout. Representative locus: DN 5 (Kūṭadanta).

---

## Appendix A: Full enumeration

The 299 canonical (mūla) awakening-events sort into ten works. The table below gives, per work, the count, the chronological stratum, the structural layer, the dominant speaker (the voice that owns the attainment-claim), the base edition, and whether the structural shelving and the composition date agree. The "early floor" is the two rows where they agree (38 events); every other row is filed as canon but reads late. Each work resolves to live corpus rows; representative ids are in the Notes above. The full machine-checkable census, one row per event with its own provenance signature, is at `public/research/awakening-events.json`.

| Work | Count | Stratum | Layer | Dominant speaker | Edition | Shelving / date agree |
|---|---:|---|---|---|---|:---:|
| Nikāya prose (DN/MN/SN/AN) | 33 | early-canonical | mūla | redactor-frame (+ buddha-vacana floor) | CST | yes |
| Udāna | 5 | early-canonical | mūla | redactor-frame | CST | yes |
| Theragāthā / Therīgāthā | 59 | archaic-or-late-canonical (contested) | mūla | named-disciple-self-report | CST | register-relative |
| Apadāna | 162 | late-canonical | mūla | hagiographic-self-narration | CST | no |
| Buddhavaṁsa | 8 | late-canonical | mūla | redactor-frame-verse | CST | no |
| Niddesa | 3 | late-canonical | mūla | redactor-frame | CST | no |
| Vinaya occasioning-stories (nidāna) | 6 | late-canonical | mūla | redactor-frame (+ buddha-vacana, Veranja) | CST | position-relative |
| Vimānavatthu | 2 | late-canonical | mūla | redactor-frame-verse | CST | no |
| Milindapañha | 4 | paracanonical | mūla | named-disciple-dialogue | CST | no |
| Visuddhimagga | 17 | classical commentary | mūla | redactor-frame | CST | no (layer/stratum disagree) |
| **Total** | **299** | | | | | |

*Per-attribution breakdown (coded per claim, across the same 299):* hagiographic-self-narration 162, named-disciple-self-report 59, redactor-frame 46, buddha-vacana 17, redactor-frame-verse 10, named-disciple-dialogue 4, buddha-declares-another 1 (sum 299).

*Dedup of the buddha-vacana class (17 rows → 9 distinct recollections):*

| Recollection | Rows merged |
|---|---|
| Bhayabherava (MN 4) | mn4 · cst-s0201m.mul-mn1_1 |
| Dvedhāvitakka (MN 19) | mn19 · cst-s0201m.mul-mn1_2 |
| Mahāsaccaka, to Aggivessana (MN 36) | mn36 |
| Bodhirājakumāra, to Prince Bodhi (MN 85) | mn85 · cst-s0202m.mul-mn2_4 |
| Saṅgārava (MN 100) | mn100 · cst-s0202m.mul-mn2_5 |
| Verañja (AN 8.11 = Vinaya Pārājika nidāna) | an8.11 · cst-s0404m1.mul-an8_1_2 · pli-tv-bu-vb-pj1 · cst-vin01m.mul-vin1_1 |
| Padīpopama, breath-meditation (SN 54.8) | sn54.8 · cst-s0305m.mul-sn5_10 |
| Pubbesambodha reflection (SN 35.13) | cst-s0304m.mul-sn4_1 |
| Vinaya Mahāvagga bodhi-narrative | cst-vin02m2.mul-vin3_1 |

*Corpus totals for context:* of the 2,214 awakening-events in the whole corpus, 299 are mūla, and 1,915 are commentarial or extra-canonical (Aṭṭhakathā 1,762, Ṭīkā 118, other 35).

---

## Appendix B: Method register

**The recall ladder, all four rungs.** Every count in this paper rests on a measured enumeration. The search of the attainment markers was widened in four rungs; the yields are a measure of the surface string, not a moving target for the census, which stays fixed at 299 canonical and 2,214 total.

| Rung | Search strategy | Yield |
|---|---|---:|
| 1 | Naive surface string for the commonest marker, as a non-specialist would type it (bar-niggahita *ṁ* form) | 2 |
| 2 | Glyph-normalised (dotted *ṃ*) plus the declined and sandhi forms of the arahatta-attainment family | 914 |
| 3 | Concept-level union, name-independent (the mass-awakening close, verse-conclusion, mind-freed-without-clinging, eye-of-the-Dhamma, birth-destroyed, declared-final-knowledge formulae) | 1,488 |
| 4 | Full event count after the doctrinal and abstract (non-event) uses of the markers are set aside | 2,214 |

The dominant recovery between rungs 1 and 2 is the glyph normalisation: the Chattha Saṅgāyana base writes the niggahita as a dotted *ṃ*, so the more familiar bar-*ṁ* surface string is near-blind. The mass-awakening marker *desanāpariyosāne* is itself informative, returning nothing in the canonical prose and many hits in the commentarial narrative, a sign that it is a compiler's framing device.

**The triage note.** This is a category-typology question (it enumerates events that each have a who, a when, and a voice), so three dimensions were coded on every event: the structural layer, the chronological stratum (coded from work and position, independently of the layer), and the attribution or speaker of the attainment-claim. The recall ladder ran throughout as the standing recall discipline. Dimensions not coded, and why: epistemic marking (an awakening is narrated as an event, not staked under the canon's verification formula); cross-recensional reach (Pāli-only corpus, coded only at link level as a secondary check on the early floor); pre-Buddhist provenance (moot, since an awakening is a Buddhist datum by definition); harmonization (no doctrinal tension is being reconciled).

**Pre-registration.** The hypotheses, the null, and the prediction were frozen before coding (2026-06; see `research/PREREGISTRATION.md` and the awakening-study prereg). The working hypothesis was that the canonical descriptions concentrate in the late strata and are mostly narrated; the null was that they spread across the layers as the structural shelving implies, with an early floor of the Buddha's own word. The shape found matches the working hypothesis on dating and on the narrated majority, with one correction against the earlier coding: the Buddha's-own-word count is not zero but a floor of 17 rows / 9 recollections.

---

## Appendix C: Inter-annotator agreement

The load-bearing category for this paper is the passages in which the Buddha speaks of his own awakening, since the whole correction against the earlier zero turns on it. Three coders worked independently and blind, from the Pāli excerpts alone, against a fixed six-value codebook. The seventeen candidate rows were drawn by a recall-anchored discriminator of strings only ever spoken by the Buddha of his own bodhi (the bodhisatta-before-awakening frame; the *paccaññāsiṁ* claim-of-awakening; the last-watch autobiography to a named hearer).

- **Agreement on the load-bearing category:** unanimous on all 17 rows, three of three coding buddha-vacana. κ = 1.0.
- **Boundary rows adjudicated:** two rows nearby in the search (SN 8.12, SN 52.24) were coded unanimously as named-disciple-self-report and excluded; two more (SN 47.29, SN 47.30) as named-disciple-dialogue and excluded; SN 55.39 as buddha-declares-another (two of three, one indeterminate), the single such row kept within the 299.
- **Packet artifacts corrected:** four rows first read as indeterminate by all three (DN 5, MN 74, MN 147, SN 35.121) were excerpt-truncation artifacts; read in full they are plain redactor-frame narration (the eye-of-the-Dhamma or mind-freed formula told flatly) and coded accordingly.

The full coding packet and the per-row matrix are retained with the dataset; the census row count (299 mūla) was held fixed throughout, so the attribution correction is not confounded with a re-enumeration of the corpus.

---

*Full machine-checkable census: `public/research/awakening-events.json`. All counts trace to `research/awakening/FINDINGS-v2.md` and `research/awakening/_attribution_audit.json`. Base edition: Chattha Saṅgāyana (CST/VRI) as ingested, with the SuttaCentral Mahāsaṅgīti reading text as the parallel canonical reading.*
