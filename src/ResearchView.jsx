          ...
          <>
            ...
            <div style={articleBody}>
              ...
              <p>
                ...
                natures, supplies the wider frame: the fixing of a person into a temperament is one local case
                of it.
              </p>
              <p>
                  ...
                  <section style={{ marginTop: 34 }}>
                    ...
                    {Array.isArray(v.stratigraphy) && v.stratigraphy.length > 0 && (
                      <>
                        ...
                        <p style={methodNote}>
                          As noted in the narrative, the stratum is a work-slug lookup rather than a
                          per-row judgement, so a row reads yes in the disagree column by construction
                          whenever its work sits later than the mūla shelf it is filed on. The column
                          restates the stratum coding; it is not a second, independent measurement.
                        </p>
                      </>
                    )}
          ...
          <>
            ...
            <div style={articleBody}>
              ...
              <p>
                ...
                too, the three unwholesome roots (<em>akusala-mūla</em>: greed, hate, delusion) of the
                Dhammasaṅgaṇī and the Vibhaṅga
                  ...
                  <section style={{ marginTop: 34 }}>
                    ...
                    {Array.isArray(v.stratigraphy) && v.stratigraphy.length > 0 && (
                      <>
                        ...
                        <p style={methodNote}>
                          The stratum here is a fixed work-to-stratum reference-table value: each row
                          takes the stratum of its source work, not a per-row judgement made afresh. The
                          disagree column is the same fact seen from the other side. A row reads yes in
                          the table precisely when its work sits later than the mūla shelf it is filed
                          on, as with the Visuddhimagga and Paṭisambhidāmagga rows, so the flag follows
                          by construction and is not a second measurement converging on the structural
                          layer. No within-canon chronology claim here rests on it.
                        </p>
                        {v.gradient_caveat && (
                          <p style={methodNote}>
          ...
          <>
            ...
            <div style={articleBody}>
              ...
              <p>
                ...
                Visuddhimagga classes their non-transgression as natural virtue (pakati-sīla), morality fixed by being
